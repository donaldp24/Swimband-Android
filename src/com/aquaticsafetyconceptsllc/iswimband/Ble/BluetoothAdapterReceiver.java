        ...
        if (BluetoothAdapter.ACTION_STATE_CHANGED.equals(intent.getAction())) {
            ...
            switch (state) {
                case BluetoothAdapter.STATE_OFF:
                    Logger.l(TAG, "BluetoothAdapter.STATE_OFF");
                    break;
                case BluetoothAdapter.STATE_ON:
                    Logger.l(TAG, "BluetoothAdapter.STATE_ON");
                    break;
                case BluetoothAdapter.STATE_TURNING_OFF:
                    Logger.l(TAG, "BluetoothAdapter.STATE_TURNING_OFF");
                    break;
                case BluetoothAdapter.STATE_TURNING_ON:
                    Logger.l(TAG, "BluetoothAdapter.STATE_TURNING_ON");
                    break;
                default:
                    break;
            }
